...
Remember, the student must use the word correctly in a sentence. This is not about multiple choice questions. The best way for them to learn is to learn how to correctly use the word in a sentence.
